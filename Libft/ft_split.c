...
/*   Updated: 2021/11/09 18:01:01 by gcolene          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*create_word(const char *s, int start, int finish)
{
	int		i;
	char	*word;
...
char	**split_maker(char const *s, char c, char **split)
{
	int		index;
	int		i;
	size_t	n;
